...
namespace HarmonyLib {
	...
	public class Harmony
	{
		...
		internal Dictionary<MethodBase, bool> patched = new Dictionary<MethodBase, bool>();

		public bool IsPatched(MethodBase patch)
			=> patched.GetValueSafe(patch);
		...
		public Harmony(string id, bool safeMode) : this(id) {
			SafeMode = safeMode;
        }
